...
const Card4 = () => {
  ...
  return (
    <>
      <div onClick={handleCardClick} className="group relative hidden xl:block overflow-hidden rounded-2xl w-56 md:w-64 h-36 md:h-36 bg-white/75 backdrop-blur-md border border-solid border-slate-200/70 shadow-[0_5px_14px_-6px_rgba(0,0,0,0.18),0_2px_6px_rgba(0,0,0,0.08)] hover:shadow-[0_10px_24px_-10px_rgba(0,0,0,0.28),0_4px_10px_rgba(0,0,0,0.12)] transition-all duration-300 cursor-pointer">
        {/* Ambient glows */}
