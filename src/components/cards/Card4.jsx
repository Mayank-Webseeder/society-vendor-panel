...
const Card4 = () => {
  ...
  return (
    <div className="relative hidden xl:block bg-[#A966EC] w-60 rounded-2xl h-40 overflow-hidden hover:scale-105 transition-transform duration-300">
      <p className="relative font-medium text-xl pl-2 text-white/90 z-30 pt-4">Applied Jobs</p>
      <p className="relative font-semibold text-white text-4xl z-30 pt-12 pl-5">{jobsApplied}</p>
