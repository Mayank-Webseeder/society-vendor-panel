...
const Card1 = () => {
  ...
  return (
    <div className="relative bg-[#5CA7D3] w-60 rounded-xl h-40 overflow-hidden hover:scale-105 cursor-pointer transition-transform duration-300">
        <p className="relative font-medium text-xl pl-2 text-white/90 z-30 pt-4">Avg. Response Time</p>
        <p className="relative font-semibold text-white text-3xl z-30 pt-12 pl-4">{user.avgResponseTime} min</p>
