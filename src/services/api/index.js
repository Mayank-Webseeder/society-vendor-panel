...
const SUMMARY_API = {
  AUTH: {
    ...
    SEND_CONTACT_OTP: `${BASE_URL}/api/vendor/sendOtpContactVerification`,
    VALIDATE_CONTACT: `${BASE_URL}/api/vendor/validateContactNumber`,
    // Keep existing email endpoints for other features
