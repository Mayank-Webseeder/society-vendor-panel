...
const JobCard = ({ job, onApply }) => {
  ...
  return (
    <div className="bg-white w-full mx-auto rounded-2xl shadow hover:shadow-lg border p-5 flex flex-col space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-green-50 p-3 rounded">
          <p className="text-sm text-green-700">Offered</p>
        ...
        <div className="bg-indigo-50 p-3 rounded">
          <p className="text-sm text-indigo-700">Experience</p>
          <p className="font-bold">{job.requiredExperience || "N/A"}</p>
        </div>
      </div>
      ...
      {job.society && (
        <div className="bg-blue-50 p-4 rounded text-sm space-y-2">
          <p className="font-semibold">{job.society.societyname}</p>
          <p>{job.society.email}</p>
          <p>{job.society.address}</p>
          <p>{job.society.residentsCount} residents</p>
        </div>
      )}
