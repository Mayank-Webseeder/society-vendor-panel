      ...
      <Paper
        ...
        sx={{
          ...
          '&::before': {
            ...
            backgroundSize: { xs: '400px 400px, 300px 300px, 20px 20px', sm: 'auto' },
            opacity: { xs: 0.7, sm: 0 },
            pointerEvents: 'none',
            zIndex: 1,
          },
          ...
          <Fade in={showContent} timeout={1000}>
            <div
              style={{ 
                ...
                maxHeight: window.innerWidth < 640 ? 'calc(80vh - 80px)' : '100%',
                gap: window.innerWidth < 640 ? 3 : 0,
                overflowY: window.innerWidth < 640 ? 'auto' : 'visible',
                paddingRight: window.innerWidth < 640 ? '8px' : '0',
                // Custom scrollbar styling for mobile
                '&::-webkit-scrollbar': window.innerWidth < 640 ? {
                  width: '4px',
                } : {},
                '&::-webkit-scrollbar-track': window.innerWidth < 640 ? {
                  background: 'rgba(255, 255, 255, 0.1)',
                  borderRadius: '2px',
                } : {},
                '&::-webkit-scrollbar-thumb': window.innerWidth < 640 ? {
                  background: 'rgba(255, 255, 255, 0.3)',
                  borderRadius: '2px',
                } : {},
                '&::-webkit-scrollbar-thumb:hover': window.innerWidth < 640 ? {
            ...
            >
              ...
              <Box sx={{ 
                ...
                {/* Mobile: Enhanced Corporate Header */}
                        <Box sx={{ 
                          ...
                          width: '60px',
                          height: '4px',
                          background: 'linear-gradient(90deg, rgba(59, 130, 246, 0.8) 0%, rgba(37, 99, 235, 0.8) 100%)', // changed color
                          borderRadius: '2px',
                          },
                        }}>
                          <Typography
                          ...
                          sx={{
                            ...
                            width: '80px',
                            height: '3px',
                            background: 'linear-gradient(90deg, rgba(59, 130, 246, 0.8) 0%, rgba(37, 99, 235, 1) 50%, rgba(29, 78, 216, 0.8) 100%)', // changed color
                            borderRadius: '2px',
                            },
                          }}
                          >
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'center', mb: 2 }}>
                    ...
                    >
                      <Briefcase size={28} color="rgba(255, 255, 255, 0.95)" />
                    </Box>
                  </Box>
                </Box>
              ...
              <div className="flex flex-col w-full items-center max-w-lg" style={{ 
                maxWidth: window.innerWidth < 640 ? '100%' : '32rem',
                flex: window.innerWidth < 640 ? 'none' : 1,
              }}>

                {/* Multi-Select Input with Info Icon */}
                <div className="relative w-[95%] sm:w-full mb-6 flex items-center gap-3" ref={dropdownRef} style={{
                  ...
                  <Zoom in={showContent} timeout={800} style={{ flex: 1 }}>
                    <div
                      ...
                      style={{
                        ...
                        backdropFilter: window.innerWidth < 640 ? 'blur(20px)' : 'blur(10px)',
                        border: window.innerWidth < 640 ? 
                          '1px solid rgba(255, 255, 255, 0.25)' : 
                          '2px solid rgba(156, 163, 175, 0.2)',
                        padding: window.innerWidth < 640 ? '14px 14px 14px 50px' : '16px 16px 16px 56px',
                        ...
                        color: window.innerWidth < 640 ? 'rgba(30, 58, 138, 0.9)' : '#374151',
                      }}
                    >
                      <Search 
                        ...
                        style={{
                          ...
                          top: '50%',
                          transform: 'translateY(-50%)',
                          color: window.innerWidth < 640 ? 'rgba(30, 58, 138, 0.8)' : '#60a5fa',
                        }}
                      />
                      <span 
                        ...
                        style={{
                          ...
                          marginLeft: window.innerWidth < 640 ? '1.75rem' : '2rem',
                          color: window.innerWidth < 640 ? 'rgba(30, 58, 138, 0.9)' : '#374151',
                        }}
                      >
                      ...
                      <ChevronDown 
                        ...
                        style={{
                          color: window.innerWidth < 640 ? 'rgba(30, 58, 138, 0.8)' : '#3b82f6',
                        }}
                      />
                    </div>
                  </Zoom>
                            ...
                            <div className="flex items-start gap-3">
                              <div className="flex-1">
                                ...
                                <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg p-3">
                                  ...
                                  >
                                    💡 Discount: Select at least {onboardingData.discountLowerLimit} services to avail special discounts!
                                  </Typography>
                                </div>
                              </div>
                            </div>
                  ...
                  {isDropdownOpen && (
                    <Fade in={isDropdownOpen} timeout={300}>
                      <div
                        ...
                        style={{ 
                          maxHeight: window.innerWidth < 640 ? '200px' : '280px',
                          overflowY: 'auto',
                          ...
                          <Zoom in={isDropdownOpen} timeout={300 + index * 50} key={offer.value}>
                            <div
                              ...
                              style={{
                                ...
                                margin: window.innerWidth < 640 ? '2px 8px' : '2px 8px',
                ...
                {window.innerWidth < 640 && (
                  <Fade in={showContent} timeout={1000}>
                    <div 
                      ...
                      style={{
                        background: 'linear-gradient(135deg, rgba(59, 130, 246, 0.08) 0%, rgba(37, 99, 235, 0.06) 50%, rgba(29, 78, 216, 0.08) 100%)',
                        backdropFilter: 'blur(20px)',
                    ...
                    >
                      ...
                      <div className="flex items-center justify-center">
                        <div className="flex items-center gap-2">
                          ...
                          >
                            Select {onboardingData.discountLowerLimit}+ services for special discounts
                          </Typography>
                        </div>
                      </div>
                    </div>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
                  <Button
                    ...
                    sx={{
                      ...
                      backdropFilter: window.innerWidth < 640 ? 'blur(20px)' : 'none',
                      border: window.innerWidth < 640 ? 
                        (selectedServices.length === 0 || !agreedToTerms) ? 
                          '2px solid rgba(156, 163, 175, 0.4)' :
                          '2px solid rgba(59, 130, 246, 0.6)' : 
                        'none',
                      color: (selectedServices.length === 0 || !agreedToTerms) ? 
                        (window.innerWidth < 640 ? 'rgba(107, 114, 128, 0.8)' : '#9ca3af') : 
                        (window.innerWidth < 640 ? 'rgba(255, 255, 255, 0.98)' : 'white'),
                      fontWeight: '600',
                      fontSize: { xs: '1.1rem', sm: '1.1rem' },
                      borderRadius: { xs: '16px', sm: '12px' },
                      boxShadow: (selectedServices.length === 0 || !agreedToTerms) ? 
                        'none' : 
                        (window.innerWidth < 640 ? 
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                        ...
                        sx={{
                          color: window.innerWidth < 640 ? 'rgba(59, 130, 246, 0.8)' : '#56A9D9',
                          '&.Mui-checked': {
                            color: window.innerWidth < 640 ? 'rgba(59, 130, 246, 1)' : '#42A5F5',
                          },
                          '&:hover': {
                          ...
                          '& .MuiSvgIcon-root': {
                            ...
                            filter: window.innerWidth < 640 ? 'drop-shadow(0 2px 8px rgba(59, 130, 246, 0.3))' : 'none',
                          },
                        }}
                      />
                    }
                    label={
                      ...
                      >
                        ...
                        <span style={{ 
                          color: window.innerWidth < 640 ? 'rgba(59, 130, 246, 0.95)' : '#56A9D9', 
                          cursor: 'pointer', 
                          fontWeight: 600,
                          textDecoration: 'underline',
                          textDecorationColor: window.innerWidth < 640 ? 'rgba(59, 130, 246, 0.5)' : 'rgba(86, 169, 217, 0.5)',
