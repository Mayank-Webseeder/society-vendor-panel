...
const ForgotPassword = () => {
  ...
  return (
    <div className="min-h-screen overflow-y-hidden flex flex-col md:flex-row font-inter overflow-hidden relative">
      ...
      {/* Right: Form Section */}
      <motion.div
        className="relative flex flex-col justify-center gap-24 items-center p-6 md:px-12
      ...
      >
        ...
        <div className="w-full max-w-md px-4 z-10">
          <div className="rounded-2xl bg-white/95 backdrop-blur-sm border-solid border border-slate-300 shadow-[0_8px_32px_rgba(0,0,0,0.08),inset_0_1px_0_rgba(255,255,255,0.8)] p-5 sm:p-6">
            <motion.h2
              className="text-xl sm:text-2xl tracking-tight font-semibold text-slate-800 text-center mb-6"
            ...
            >
              ...
              <motion.p
                className="text-left font-medium text-sm text-slate-600"
              ...
              {showResend && (
                ...
                >
                  ...
                  <span className="text-sm text-slate-700 font-semibold min-w-[40px] text-right">
              ...
              <motion.button
                ...
                className={`w-full border-none text-lg text-white font-bold py-3 rounded-lg shadow-lg cursor-pointer
                           ...
                           ${email.trim() === "" ? "bg-gray-500 text-gray-300 cursor-not-allowed" : ""}`}
                style={email.trim() !== "" ? {
                  background: 'linear-gradient(135deg, #3b82f6 0%, #2563eb 50%, #1d4ed8 100%)',
                  boxShadow: '0 4px 12px rgba(59,130,246,0.2)'
                } : {}}
                disabled={email.trim() === ""}
                whileHover={email.trim() !== "" ? {
                  y: -2,
