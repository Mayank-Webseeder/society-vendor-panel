        ...
        <div className="w-full max-w-md px-4 z-10">
          <div className="rounded-2xl bg-white/95 backdrop-blur-sm border-solid border border-slate-300 shadow-[0_8px_32px_rgba(0,0,0,0.08),inset_0_1px_0_rgba(255,255,255,0.8)] p-5 sm:p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                <label htmlFor="password" className="block text-slate-600 text-sm font-medium mb-2">
                  Create New Password
                </label>
                <input
                  type="password"
                  ...
                  className="w-full px-4 py-2.5 border-solid border border-slate-300 rounded-lg placeholder-slate-400
                             focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent
                             text-slate-800 bg-slate-50 shadow-inner transition-all duration-200 text-base"
                  value={password}
              ...
              >
                <label htmlFor="confirmPassword" className="block text-slate-600 text-sm font-medium mb-2">
              ...
              {/* Info Text */}
              <motion.p
                className="text-left font-medium text-sm text-slate-600 mb-6"
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
