  ...
  const societyFeatures = [
    {
      ...
      benefits: ['Digital Record Keeping', 'Automated Workflows', 'Compliance Management'],
      color: '#3b82f6'
    },
    {
      id: 'maintenance',
      ...
      benefits: ['Real-time Tracking', 'Vendor Management', 'Quality Assurance'],
      color: '#f59e0b'
    },
    {
      id: 'financial',
      ...
      benefits: ['Automated Billing', 'Expense Tracking', 'Financial Analytics'],
      color: '#10b981'
    },
    {
      id: 'communication',
      ...
      benefits: ['Instant Notifications', 'Event Management', 'Feedback System'],
      color: '#8b5cf6'
    },
    {
      id: 'security',
